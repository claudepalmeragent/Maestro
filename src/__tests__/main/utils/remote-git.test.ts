/**
 * Tests for remote-git.ts — covers execGit() dispatch, remoteCwd fallback,
 * execGitRemote(), and remote worktree operations.
 */
...
describe('remote-git.ts', () => {
	beforeEach(() => {
		...
		// Default: execFileNoThrow returns success
		mockExecFileNoThrow.mockResolvedValue(successResult('true\n'));
	});
	...
	describe('execGit', () => {
		...
		it('should NOT use localCwd when remoteCwd is explicitly provided', async () => {
			...
			await execGit(['status'], '/should/be/ignored', sshRemote, '/remote/used/path');
	...
	// =========================================================================
	// execGit — SSH execution WITHOUT remoteCwd (the bug fix)
	// =========================================================================
	describe('execGit — SSH execution WITHOUT remoteCwd (the bug fix)', () => {
		...
		it('should use the correct path for git isRepo check over SSH', async () => {
			...
			await execGit(['rev-parse', '--is-inside-work-tree'], '/home/user/my-project', sshRemote);
		...
		it('should use the correct path for git status over SSH', async () => {
			...
			await execGit(['status', '--porcelain'], '/home/user/my-project', sshRemote);
		...
		it('should use the correct path for git branch over SSH', async () => {
			...
			await execGit(['rev-parse', '--abbrev-ref', 'HEAD'], '/home/user/my-project', sshRemote);
	...
	// =========================================================================
	// execGit — return value passthrough
	// =========================================================================
