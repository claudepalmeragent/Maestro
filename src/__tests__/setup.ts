...
// Mock notificationStore globally — components using useNotificationStore/notifyToast need defaults.
...
// Mock modalStore globally — many components use useModalStore/useModalActions.
// This mock provides safe defaults for all tests.
vi.mock('../renderer/stores/modalStore', () => {
	...
	const mockActions = {
		...
		deleteAgentModalOpen: false,
		setDeleteAgentModalOpen: vi.fn(),
		deleteAgentSession: null,
		...
		lightboxIsGroupChat: false,
		lightboxAllowDelete: false,
		setLightboxIsGroupChat: vi.fn(),
		setLightboxAllowDelete: vi.fn(),
		...
		showHistoricalAgentError: vi.fn(),
		...
		setWindowsWarningModalOpen: vi.fn(),
		directorNotesOpen: false,
		setDirectorNotesOpen: vi.fn(),
		confirmModalTitle: undefined,
		confirmModalDestructive: undefined,
	};

	return {
		useModalStore: Object.assign((selector?: any) => (selector ? selector(mockState) : mockState), {
			getState: () => mockState,
			setState: vi.fn(),
			subscribe: vi.fn(),
		}),
		useModalActions: vi.fn(() => mockActions),
		getModalActions: vi.fn(() => mockActions),
		selectModalOpen: () => () => false,
		selectModalData: () => () => undefined,
