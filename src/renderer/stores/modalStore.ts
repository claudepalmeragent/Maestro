...
/** Usage dashboard modal data */
export interface UsageDashboardModalData {
	initialTab: string | undefined;
}

/** New group chat modal data */
export interface NewGroupChatModalData {
...
export interface ModalDataMap {
	...
	usageDashboard: UsageDashboardModalData;
	newGroupChat: NewGroupChatModalData;
}
...
export function getModalActions() {
	...
	return {
		...
		setUsageDashboardOpen: (open: boolean) =>
			open ? openModal('usageDashboard', { initialTab: undefined }) : closeModal('usageDashboard'),
		setUsageDashboardInitialTab: (tab: string | undefined) =>
			updateModalData('usageDashboard', { initialTab: tab }),
		...
		setShowNewGroupChatModal: (open: boolean) =>
			open ? openModal('newGroupChat', { folderId: undefined }) : closeModal('newGroupChat'),
		setCreateGroupChatForFolderId: (folderId: string | undefined) =>
			folderId != null
				? openModal('newGroupChat', { folderId })
				: updateModalData('newGroupChat', { folderId: undefined }),
...
export function useModalActions() {
	...
	const usageDashboardData = useModalStore(selectModalData('usageDashboard'));
	...
	const newGroupChatData = useModalStore(selectModalData('newGroupChat'));
	...
	return {
		...
		// Usage Dashboard
		usageDashboardOpen,
		usageDashboardInitialTab: usageDashboardData?.initialTab,
		...
		createGroupChatForFolderId: newGroupChatData?.folderId,
