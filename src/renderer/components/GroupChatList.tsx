...
function GroupChatListInner({
	...
	// Filter and sort group chats: apply project folder filter, show active chats,
	// plus archived if toggled. When the unread-agents filter is on, also drop
	// idle chats (keeping the active one so the user doesn't lose their place).
