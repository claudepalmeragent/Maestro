...
- ⚡ **[Maestro Cue](./maestro-cue)** - Event-driven automation that fires agent prompts in response to file changes, timers, agent completions, GitHub activity, pending markdown tasks, and CLI triggers. Configure subscriptions in `.maestro/cue.yaml`; visualize and edit them in the Pipeline Editor. _(Encore Feature - enable in Settings > Encore Features)_
